        ...
        <div className="bg-gray-100 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto bg-white shadow-2xl rounded-2xl overflow-hidden">
                <div className="px-6 py-8 border-b border-gray-200">
                    <h1 className="text-4xl font-extrabold text-gray-800 text-center">سلة التسوق</h1>
                </div>
                ...
                <div className="bg-gray-100 p-8">
                    <div className="max-w-md mx-auto">
                        <div className="flex justify-between items-center mb-6">
                            <span className="text-2xl font-bold text-gray-700">المجموع الكلي</span>
                            <span className="text-3xl font-extrabold text-gray-900">
                                {totalPrice} دينار
                            </span>
                        </div>
                        <Link to="/checkout" className="w-full bg-purple-600 text-white py-4 rounded-xl
