    ...
    <nav className="bg-[#CB9DF0] py-4 shadow-md fixed top-0 left-0 right-0 z-10">
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        <ul className="flex items-center space-x-6 text-white">
          <li><Link to="/home" className="hover:text-[#F0C1E1] transition-colors duration-300">الرئيسية</Link></li>
          <li><Link to="/products" className="hover:text-[#F0C1E1] transition-colors duration-300">المنتجات</Link></li>
          <li><Link to="/workshops" className="hover:text-[#F0C1E1] transition-colors duration-300">الورش التدريبية</Link></li>
          <li><Link to="/about" className="hover:text-[#F0C1E1] transition-colors duration-300">من نحن</Link></li>
          <li><Link to="/newsletter" className="hover:text-[#F0C1E1] transition-colors duration-300">اشترك في النشرة</Link></li>
        </ul>
      </div>
    </nav>
  );
